...
/**
 * 
 * This class represents an implication between two CTL state formulas.
 * 
 */

public class Implies extends StateFormula {
	 ...
	 */
	public Implies(StateFormula left, StateFormula right) {
		this.left = left;
		this.right = right;
	}
	...
	/**
	 * Returns the {@code hashCode} of this <i>Implies</i> formula.
	...
	/**
	 * Returns a string representation of this <i>Implies</i> formula.
