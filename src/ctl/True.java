...
/**
 * 
 * This class represents a <i>True</i> formula in CTL.
 * 
 */

public class True extends StateFormula {

	boolean formula;	// store as a primitive boolean for the smallest footprint
	
	/**
	 * Initializes the {@code formula} field to <i>true</i>.
	 */
	public True() {
		this.formula = true;
	}
	...
	/**
	 * Returns the {@code hashCode} of this <i>True</i> formula.
	...
	/**
	 * Returns a string representation of this <i>True</i> formula.
